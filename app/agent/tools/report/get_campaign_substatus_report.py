"""Tool: Leads per CAMPAIGN broken down by SUB-STATUS.
...
@tool
def get_campaign_substatus_report(
    ...
    """Leads per CAMPAIGN broken down by SUB-STATUS - campaign performance.

    Returns one row per campaign, with the counts as the CRM reports them -
