"""Tool: Leads per CHANNEL PARTNER broken down by SUB-STATUS..
...
@tool
def get_channel_partner_substatus_report(
    ...
    """Leads per CHANNEL PARTNER broken down by SUB-STATUS.

    Returns one row per channel partner, with the counts as the CRM reports them -
