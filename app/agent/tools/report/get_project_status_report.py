"""Tool: Leads per PROJECT broken down by STATUS..
...
def get_project_status_report(
    ...
    """Leads per PROJECT broken down by STATUS.

    Returns one row per project, with the counts as the CRM reports them -
