"""Tool: Leads per SUB-SOURCE broken down by STATUS..
...
@tool
def get_subsource_status_report(
    ...
    """Leads per SUB-SOURCE broken down by STATUS.

    Returns one row per sub-source, with the counts as the CRM reports them -
