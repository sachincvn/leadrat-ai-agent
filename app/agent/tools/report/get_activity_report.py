...
def get_activity_report(
    ...
    """Per-user activity: meetings and site visits scheduled, done and not done, bookings, status edits, notes added, and communications initiated (calls, WhatsApp, email, SMS), plus average working hours. Four count slices merged into one row per user.

    Returns one row per user, with the counts as the CRM reports them -
