"""Tool: Leads per USER broken down by SUB-STATUS, one level finer than the status report..
...
def get_user_substatus_report(
    ...
    """Leads per USER broken down by SUB-STATUS, one level finer than the status report.
