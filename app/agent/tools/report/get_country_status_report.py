"""Tool: Leads per COUNTRY broken down by STATUS..
...
def get_country_status_report(
    ...
    """Leads per COUNTRY broken down by STATUS.

    Returns one row per country, with the counts as the CRM reports them -
